    ...
    render: () => (
      <>
        ...
        <P>
          ...
          are picked from a list an admin maintains at{" "}
          <strong>Admin → Maintenance reference lists</strong>. Adding a
          department or a location there makes it available everywhere in the
          CMMS immediately — no ticket, no waiting.
        </P>
        <P>
