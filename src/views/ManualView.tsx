    ...
    render: () => (
      <>
        ...
        <P>
          ...
          entries shown are still correct — the app just had to download more
          than it should have. Expand <em>"What SharePoint said"</em> in the
          notice and send that to IT along with the row count; on a big list the
          usual fix is indexing the <strong>Enter Date</strong> column.
        </P>
