      ...
      <form id="panel-qc-issue-form" onSubmit={submit} className="contents">
        <div className="rounded-lg border border-border bg-surface p-4 sm:p-5">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <Field label={<span className="inline-flex flex-wrap items-baseline gap-2">Failure Reported <span className="text-[11px] font-normal normal-case tracking-normal text-cooper-red">*Ensure to attach any and all relevant photos, configuration files, and documents related to failure</span></span>} className="sm:col-span-2"><AutoGrowTextarea value={draft.failureReported} onChange={(e) => set("failureReported", e.target.value)} rows={3} className="input resize-y" /></Field>
