      ...
      <form id="panel-qc-issue-form" onSubmit={submit} className="contents">
        <div className="rounded-lg border border-border bg-surface p-4 sm:p-5">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Field label="Panel / Board Serial Number"><input ref={firstFieldRef} value={draft.panelSerialNumber} onChange={(e) => set("panelSerialNumber", e.target.value)} className="input" /></Field>
