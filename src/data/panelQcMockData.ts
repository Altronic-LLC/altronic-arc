...
export const MOCK_PANEL_QC_ISSUES: PanelQcIssue[] = [
  {
    ...
    comments: "Fuse F5 red LED indicator light did not illuminate while pulled.",
  ...
  },
  {
    ...
    comments: "Terminal board 1 AO3 bounced from 5.1mA to 5.7mA at 0%.",
    correctiveAction: "Replaced the board and fully tested the new one with no issues.",
  ...
  },
  {
    ...
    comments: "IN-11 would not get out of a faulted state even with wiring and dip switch correct.",
    correctiveAction: "",
    productionTechnician: "",
    productionRepairNotes: "",
    productionResolution: "",
